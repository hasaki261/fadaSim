...
**Chance.js**, **Piscina.js** (and **d3-array**) were used to keep the code cleaner, but you can achieve the same result natively using `Math.random()` function and Workers Threads module.
